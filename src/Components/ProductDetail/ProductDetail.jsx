  ...
  return (
    <div className='flex flex-col h-screen'>
      ...
      <div className='w-full'>
        ...
        <img className='w-80 h-auto object-fit ' src={require('../../Assets/' + thisProduct.image + '.jpg')} alt={thisProduct.title} />
        </div>
        <div className='flex flex-col items-start m-4'>
          ...
          <p className='text-start my-6'>{thisProduct.ingredients}</p>
          <button className='bg-black text-white w-full py-4' onClick={() => dispatch(addToCart())}>Add To Cart</button>
        </div>
      </div>
    </div>
  )
